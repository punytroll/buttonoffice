namespace ButtonOffice
{
    internal abstract class Goal : ButtonOffice.PersistentObject
    {
        ...
        public void Activate(ButtonOffice.Game Game, ButtonOffice.Person Person, System.Single Minutes)
        {
            System.Diagnostics.Debug.Assert(_State == ButtonOffice.GoalState.Inactive);
            _State = ButtonOffice.GoalState.Active;
            _OnActivate(Game, Person, Minutes);
        }

        protected virtual void _OnActivate(ButtonOffice.Game Game, ButtonOffice.Person Person, System.Single Minutes)
        {
        }

        public void Execute(ButtonOffice.Game Game, ButtonOffice.Person Person, System.Single Minutes)
        {
            System.Diagnostics.Debug.Assert(_State == ButtonOffice.GoalState.Active);
            _OnExecute(Game, Person, Minutes);
        }

        protected virtual void _OnExecute(ButtonOffice.Game Game, ButtonOffice.Person Person, System.Single Minutes)
        {
        }

        public void Terminate(ButtonOffice.Game Game, ButtonOffice.Person Person, System.Single Minutes)
        {
            System.Diagnostics.Debug.Assert(SubGoals.Count == 0);
            _OnTerminate(Game, Person, Minutes);
            _State = ButtonOffice.GoalState.Terminated;
        }

        protected virtual void _OnTerminate(ButtonOffice.Game Game, ButtonOffice.Person Person, System.Single Minutes)
        {
        }
